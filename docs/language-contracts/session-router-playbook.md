...
Superpowers for Codex treats session routing as a harness contract. The source of truth is this playbook plus `skills/using-superpowers/SKILL.md`.
...
3. Decide whether a more specific Superpowers skill applies.
...
3. Superpowers playbooks and skills.
4. Default assistant behavior.

When a repo contract and a Superpowers skill disagree, follow the repo contract unless the user says otherwise.
...
When the user wants the Superpowers router explicitly, a stable manual prompt is:
